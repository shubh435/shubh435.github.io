...
function SummarySection() {
  return (
    <section className="py-14 px-4 md:px-6 lg:px-10" aria-labelledby="summary-heading">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid lg:grid-cols-[1.15fr,0.85fr] gap-6 items-stretch">
          ...
          <div
            className="surface-card rounded-2xl p-6 shadow-xl h-full"
          ...
          <div
            className="surface-card rounded-2xl p-6 h-full flex flex-col gap-4"
            style={{ border: '1px solid var(--border-subtle)' }}
          >
            ...
            <div className="space-y-3" style={{ color: 'var(--text-muted)' }}>
              <p className="flex items-start gap-3">
                <FaCheckCircle className="text-green-400 mt-1 flex-shrink-0" aria-hidden="true" />
                <span>Weekly demos and transparent, ticket-sized milestones.</span>
              </p>
              <p className="flex items-start gap-3">
                <FaCheckCircle className="text-green-400 mt-1 flex-shrink-0" aria-hidden="true" />
                <span>Documented handoffs with Loom walkthroughs + Notion specs.</span>
              </p>
              <p className="flex items-start gap-3">
                <FaCheckCircle className="text-green-400 mt-1 flex-shrink-0" aria-hidden="true" />
                <span>
                  Accessibility-first mindset: keyboard support and WCAG-friendly contrast.
                </span>
              </p>
            </div>
            <div
            ...
            >
              Collaboration-first, async-friendly, and ready for hands-on coding or audits.
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          <div
            className="surface-card rounded-2xl p-6 h-full"
            style={{ border: '1px solid var(--border-subtle)' }}
          >
          ...
          <div
            className="surface-card rounded-2xl p-6 h-full flex flex-col justify-between"
            style={{ border: '1px solid var(--border-subtle)' }}
          >
            <div className="space-y-3">
              ...
              <p className="text-lg leading-relaxed" style={{ color: 'var(--text-muted)' }}>
                I love partnering with teams that want to move fast without compromising craft.{' '}
