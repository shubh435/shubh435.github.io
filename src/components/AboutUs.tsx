...
const keyStrengths = [
  {
    ...
    description: 'Crafting precise, polished interfaces that match designs exactly',
  },
  {
        ...
        <div className="space-y-2">
          ...
          <p className="text-lg max-w-2xl" style={{ color: 'var(--text-muted)' }}>
            ...
            <strong style={{ color: 'var(--text-primary)' }}>
              {calculateDateDifference('2022-06-25')}+ years
            </strong>{' '}
            of experience shipping polished mobile and web products for startups and enterprise
            teams.
          </p>
        </div>
