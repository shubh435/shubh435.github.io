            ...
            {experiences.map((exp, index) => (
              <FadeInWhenVisible key={index}>
                <div className="relative">
                  <div
                    className="absolute left-6 w-4 h-4 rounded-full border-4 shadow-lg hidden md:block"
                    style={{ background: 'var(--accent)', borderColor: 'var(--bg-main)' }}
                  ></div>
                  ...
                  <div className="md:ml-16 glass-panel p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                      ...
                      <div
                        className="text-sm md:text-right mt-4 md:mt-0"
