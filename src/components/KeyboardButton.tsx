...
interface KeyBoardButtonState {

}

class KeyBoardButton extends React.Component<KeyBoardButtonProps, KeyBoardButtonState> {
    constructor(props: KeyBoardButtonProps) {
        super(props);
        this.state = {};
    }
    render() {
                    ...
                    <div className="inner">
                        ...
                        >
                            <g className="symbol" filter="url(#inset-shadow)">
                                ...
                                ></path>
                                <circle cx="343" cy="215" r="30"></circle>
                                <circle cx="46" cy="215" r="30"></circle>
                            </g>
                            ...
                            <g className="symbol-path">
                                <circle cx="343" cy="215" r="10"></circle>
                                <circle cx="46" cy="215" r="10"></circle>
                                <path
                                    d="M188.5 213.5L189.5 29L291.5 122C200.028 205.699 151.078 251.942 64 340"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
