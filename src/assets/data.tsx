...
import { FaReact, FaGithub, FaGitlab, FaAws, FaNode, FaGit } from 'react-icons/fa';
import {
  SiTypescript,
  SiJavascript,
  SiRedux,
...
export const projectdata: ProjectData[] = [
  ...
  },
  {
    ...
    problem: 'Marketing teams struggled to A/B test hero messaging and CTAs without dev support.',
    solution:
...
export const blogPosts: BlogPost[] = [
  ...
  {
    id: 2,
    title: 'React Native Animation: Build a Bouncing Ball Loader in React Native',
    description:
