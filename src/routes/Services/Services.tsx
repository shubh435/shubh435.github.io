...
const ServicesPage: React.FC = () => {
  ...
  return (
    <HelmetProvider>
      <Helmet>
        <title>
          Freelance React & React Native Developer | Services – Shubham Sarode
        </title>
        <meta
          name="description"
        ...
        <section className="relative overflow-hidden pt-28 pb-20 px-5 sm:px-8 lg:px-12">
          ...
          <div className="relative mx-auto max-w-5xl flex flex-col items-center text-center gap-6">
            ...
            <FadeIn delay={0.1}>
              ...
              >
                Helping startups and businesses build scalable, high-quality web
                and mobile applications — on time, on budget, and built to last.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.15}>
              <div className="flex flex-col sm:flex-row items-center gap-4 mt-2">
                ...
                <button
                  onClick={() =>
                    navigateTo(
                      "https://calendly.com/shubhamsarode435",
                      navigate,
                    )
                  }
            ...
            <FadeIn>
              <div className="mb-12 text-center">
                ...
                <p
                  ...
                  style={{ color: "var(--text-muted)" }}
                >
                  Tailored solutions across the full product lifecycle — from
                  idea to deployment.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn>
              <div className="mb-12 text-center">
                ...
                <p
                  ...
                  style={{ color: "var(--text-muted)" }}
                >
                  The tools I use to deliver production-ready, modern
                  applications.
                </p>
              </div>
            </FadeIn>
            ...
            <div className="mx-auto max-w-4xl overflow-hidden rounded-3xl relative">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "var(--text-muted)" }}
                >
                  Whether you have a fully-scoped project or just an idea — I'd
                  love to hear about it. Let's talk about what we can build.
                </p>
