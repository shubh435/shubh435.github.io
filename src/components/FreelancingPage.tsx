        ...
        <header className="flex flex-col gap-12 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-3xl space-y-6 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl" style={{ color: 'var(--text-muted)' }}>
              I partner with startups and product teams on conversion-driven interfaces, resilient
              mobile apps, and full-stack web experiences.
            </p>
            ...
            >
              ...
              <li className="flex items-start gap-3">
                <span
                  ...
                  style={{ background: 'var(--accent)' }}
                ></span>
                Performance budgets, accessibility guardrails, and deployment support
              </li>
            </ul>
          </div>
        </header>
          ...
          <div className="mb-10 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="mt-2 text-base md:text-lg" style={{ color: 'var(--text-muted)' }}>
                Tailored React and React Native solutions tuned for launch or scale.
              </p>
            </div>
          </div>
