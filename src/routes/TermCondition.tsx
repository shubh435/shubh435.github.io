...
function TermCondition() {
  return (
    ...
    >
      ...
      <p>
        These terms and conditions apply to the MediMinder - Pill reminder app
        (hereby referred to as "Application") for mobile devices that was
        created by Shubham Sarode (hereby referred to as "Service Provider") as
      ...
      <p>
        ...
        extract the source code of the Application, translate the Application
        into other languages, or create derivative versions are not permitted.
      ...
      <p>
        ...
        lack of access to Wi-Fi or if you have exhausted your data allowance.
      </p>
